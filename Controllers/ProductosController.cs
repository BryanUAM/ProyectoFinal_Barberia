...
namespace BarberiaLosHermanos.Controllers
{
    ...
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Nombre,Precio,Disponible")] Producto producto)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Nombre,Precio,Disponible")] Producto producto)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!_context.Producto.Any(e => e.ProductoId == producto.ProductoId))
                        return NotFound();
                    throw;
                }
            }
